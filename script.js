...
const flipTime = function () {
  ...
  // create time animation intro
  document
    .querySelectorAll('.current-top-number')
    .forEach(num => num.classList.add('show'));
  document
    .querySelectorAll('.current-bottom-number')
    .forEach(num => num.classList.add('show'));
  document
    .querySelectorAll('.next-number')
    .forEach(num => num.classList.add('show'));
